...
namespace Keyboard2DS4.MainWindow.EffectEx.TranslationalEffect
{
    public class TranslationalEffect : ShaderEffect
    {
        ...
        public TranslationalEffect()
        {
            ...
            {
                UriSource = new Uri($"pack://application:,,,/{AssemblyName};component/MainWindow/EffectEx/TranslationalEffect/TranslationalEffect.ps"),
            };
